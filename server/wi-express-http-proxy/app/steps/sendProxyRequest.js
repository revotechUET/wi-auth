...
let chunkLength = require('../../lib/chunkLength');
...
function sendProxyRequest(Container) {
    ...
    return new Promise(function (resolve, reject) {
        let protocol = Container.proxy.requestModule;
        let proxyReq = Container.proxy.req = protocol.request(reqOpt, function (rsp) {
            if (options.stream) {
